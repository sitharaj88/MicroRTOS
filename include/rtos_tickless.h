...
#ifndef RTOS_TICKLESS_H
#define RTOS_TICKLESS_H
...
#define RTOS_TICKLESS_MIN_TICKS     2   /* Minimum ticks worth sleeping */
#endif

#ifndef RTOS_TICKLESS_MAX_TICKS
#define RTOS_TICKLESS_MAX_TICKS     0xFFFFFF    /* Maximum sleep duration */
#endif
...
typedef enum {
    RTOS_SLEEP_IDLE = 0,        /* Lightest sleep, fastest wake */
    RTOS_SLEEP_STANDBY,         /* Deeper sleep, slower wake */
    RTOS_SLEEP_POWER_DOWN,      /* Deepest sleep, slowest wake */
} rtos_sleep_mode_t;
...
typedef struct {
    ...
    rtos_sleep_mode_t   sleep_mode;         /* Configured sleep mode */
 ...
 */
extern void rtos_port_tickless_setup(uint32_t sleep_ticks);
 ...
 */
extern void rtos_port_sleep_enter(rtos_sleep_mode_t mode);
 ...
 */
extern uint32_t rtos_port_tickless_get_elapsed(void);

/**
 * Restore normal tick operation after sleep.
 * Platform-specific implementation required.
 */
extern void rtos_port_tickless_restore(void);
 ...
 */
extern bool rtos_port_tickless_timer_wakeup(void);
 ...
 */
extern void rtos_tickless_pre_sleep_hook(uint32_t expected_ticks);
 ...
 */
extern void rtos_tickless_post_sleep_hook(uint32_t slept_ticks);
